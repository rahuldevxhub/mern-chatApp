...
import rahulprofile from "../assets/rahulprofile.jpeg";
    ...
    selectedUser && (
      <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`} >
        <div className="pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto">
          {
            selectedUser?.profilePic ?(<img src= {selectedUser.profilePic}className="w-20 h-20 rounded-full"/>):
          ...
          {onlineUser?.some(id => id === selectedUser._id) && 
        ...
        <div className="px-5 text-xs">
          <p>Media</p>
          <div className="mt-2 max-h-50 overflow-y-scroll grid grid-cols-2 gap-2">
            {
