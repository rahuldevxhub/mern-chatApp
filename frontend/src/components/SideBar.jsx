    ...
    >
      <div className="pb-5">
        <div className="flex justify-between items-center">
          ...
          <div className="relative py-2 group">
            <MoreVertIcon className="max-h-5 cursor-pointer" />
      ...
      <div className="flex flex-col">
        {filteredUsers.map((user, index) => (
          ...
          className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm:text-sm ${selectedUser}? ._id == && 'bg-[#282142]/50'`}>
            {user?.profilePic ? (
  <img
    src={user.profilePic}
